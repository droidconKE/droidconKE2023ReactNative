export default {
  data: [
    ...
    },
    {
      ...
      is_keynote: false,
      session_image:
        'https://res.cloudinary.com/droidconke/image/upload/v1667568107/prod/upload/sessions/qvazpqwdef2bhpaj9g4g.png',
      speakers: [
        {
          name: 'Juma Allan',
  ...
  meta: {
    paginator: {
      ...
      per_page: '20',
      current_page: 1,
      next_page: 'https://api.droidcon.co.ke/v1/events/droidconke-2022-281/sessions?per_page=20&page=2',
      has_more_pages: true,
      next_page_url: 'https://api.droidcon.co.ke/v1/events/droidconke-2022-281/sessions?per_page=20&page=2',
